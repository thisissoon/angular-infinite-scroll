...
describe('InfiniteScrollDirective', () => {
  ...
  it('should emit event onScrollEnd event', fakeAsync(() => {
    const spy = spyOn(directive.onScrollEnd, 'emit');
  ...
  it('should emit event onScrollEnd event with offset', fakeAsync(() => {
    const spy = spyOn(directive.onScrollEnd, 'emit');
    directive.offset = 50;
